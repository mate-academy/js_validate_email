...
describe(`Function 'validateEmail':`, () => {
  ...
  it(`should return false if "! $ % & ' * + / = ? ^ { | } ~" is in email`
    , () => {
      const mail1 = 'email!@test.com';
      const mail2 = 'email$@test.com';
      ...
      expect(validateEmail(mail3))
        .toBe(false);

      expect(validateEmail(mail4))
        .toBe(false);

      expect(validateEmail(mail5))
        .toBe(false);

      expect(validateEmail(mail6))
        .toBe(false);

      expect(validateEmail(mail7))
        .toBe(false);

      expect(validateEmail(mail8))
        .toBe(false);

      expect(validateEmail(mail9))
        .toBe(false);

      expect(validateEmail(mail10))
        .toBe(false);

      expect(validateEmail(mail11))
        .toBe(false);

      expect(validateEmail(mail12))
        .toBe(false);

      expect(validateEmail(mail13))
        .toBe(false);

      expect(validateEmail(mail14))
        .toBe(false);

      expect(validateEmail(mail15))
        .toBe(false);
    });
