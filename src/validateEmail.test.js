...
describe(`Function 'validateEmail':`, () => {
  ...
  it('should return "false" for name part starting with dot', () => {
    expect(validateEmail('.test@gmail.com')).toBe(false);
  });

  it('should return "false" for name part ending with dot', () => {
    expect(validateEmail('test.@gmail.com')).toBe(false);
  });

  it('should return "false" for name ending with two dots', () => {
  ...
  it('should return "true" valid email with hyphen,underscore,numbers', () => {
    expect(validateEmail('test-838_123@gmail.com')).toBe(true);
  });
  ...
  it('should return "true" for a valid email with dot in the domain', () => {
    expect(validateEmail('test838@mai...uk')).toBe(true);
  });
