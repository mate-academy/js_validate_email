...
describe(`Function 'validateEmail':`, () => {
  ...
  it(`should return 'false' for email starts with dot '.' in username`, () => {
    expect(validateEmail('.test838@mail.com'))
      .toBeFalsy();
  });
  ...
  it(`should return 'false' for email includes double dot '..' in username`,
    () => {
      expect(validateEmail('test..838@mail.com'))
        .toBeFalsy();
    });
  ...
  it(`should return 'false' for email with non-English letter in username`,
    () => {
      expect(validateEmail('tßäö838@mail.com'))
        .toBeFalsy();
    });
